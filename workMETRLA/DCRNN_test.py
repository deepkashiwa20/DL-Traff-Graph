...
class DCRNN(nn.Module):
    def __init__(self, num_nodes:int, input_dim:int, out_horizon:int, P, K=3, hidden_dim=64, num_layers=2, bias=True, activation=None):
...
def main():    
    ...
    adj_mx = adj_mx[0]
    print(adj_mx.shape)
    #     model = DCRNN(num_nodes=N_NODE, input_dim=CHANNEL, out_horizon=TIMESTEP_OUT).to(device)
